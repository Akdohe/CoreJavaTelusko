...
public class StringEx1 {
    public static void main(String[] args) {
      ...
      //    System.out.println(sb);
         ...
         sb.insert(6, "Java "); // to insert character at specified index
       System.out.println(sb);

       sb.setLength(30);// to set the length of the string
       System.out.println("After setting length: " + sb.length());
